...
const StoreOrderSummary: FC<Props> = ({ group }) => {
  const paymentDetails = group.orderId?.paymentDetails;
  const paymentStatus = group.orderId?.paymentStatus as PaymentStatus;
  const shippingAddress = group.orderId?.shippingAddressId;
