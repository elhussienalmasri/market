...
import { applySeller } from "@/api/store";
...
export default function Step3({
  ...
  setFormData: Dispatch<SetStateAction<Partial<StoreData>>>;
  step: number;
      ...
      <AnimatedContainer>
        <div className="pl-1 text-gray-600 mt-2 mb-4">
          <p className="font-medium">
            Complete your store’s default shipping information (optional).
          </p>
          <ul className="list-disc text-sm ml-4 mt-2">
            <li>Any fields left blank will use our default form data.</li>
            <li>
              Don't worry—you can change your details anytime in your seller
              dashboard.
            </li>
            <li>
              You can update shipping settings for individual countries at any
              time later.
            </li>
          </ul>
        </div>
