...
const ProductPrice: FC<Props> = ({ sizeId, sizes, isCard, handleChange }) => {
  ...
  // Option 1: No sizeId passed, calculate range of prices and total quantity
  if (!sizeId) {
  ...
  // Option 2: SizeId passed, find the specific size and return its details
  const selectedSize = sizes.find((size) => size._id === sizeId);
