    ...
    <Document>
      <Page style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text>{order.shippingAddressId.phone}</Text>
          <Text>{order.shippingAddressId.address1}</Text>
          {order.shippingAddressId.address2 && (
            <Text>{order.shippingAddressId.address2}</Text>
          )}
          <Text>
            {order.shippingAddressId.city}, {order.shippingAddressId.state}
            ,&nbsp;
            {order.shippingAddressId.zip_code}
          </Text>
          <Text>{order.shippingAddressId.country?.name}</Text>
        </View>
        {/* Order Groups */}
